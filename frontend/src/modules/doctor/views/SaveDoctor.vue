        ...
        <template #content>
            <div class="p-fluid grid">
                ...
                <b-row>
                    ...
                    <b-col class="mt-3" cols="12" md="6" lg="4" sm="12">
                        <div class="field">
                            <span class="p-float-label p-input-icon-right" :class="{ 'invalid-field-custom': v$.lastname.$error }">
                                <i class="pi pi-user" />
                            ...
                            <div class="text-danger text-start pt-1">
                                ...
                                <p class="error-messages" v-if="v$.lastname.$dirty && v$.lastname.onlyLettersAndAccents.$invalid">
                ...
                <b-row>
                    <b-col class="mt-4" cols="12" md="6" lg="4">
                        <div class="field">
                            <span class="p-float-label p-input-icon-right" :class="{ 'invalid-field-custom': v$.curp.$error }">
                                <i class="pi pi-id-card" />
                                <InputText id="field-curp" type="text" v-model="v$.curp.$model" @input="() => v$.curp.$model = v$.curp.$model.toUpperCase()"/>
                    ...
                    <b-col class="mt-4" cols="12" md="6" lg="4">
                        <div class="field">
                            <span class="p-float-label p-input-icon-right" :class="{ 'invalid-field-custom': v$.birthDate.$error }">
                                <i class="pi pi-calendar" />
                                <Calendar id="field-birthdate" :maxDate="getNewDate()" v-model="v$.birthDate.$model" dateFormat="yy-mm-dd"/>
                            ...
                            <div class="text-danger text-start pt-1">
                                ...
                                <p class="error-messages" v-if="v$.birthDate.$dirty && v$.birthDate.dateFormat.$invalid">
                    ...
                    <b-col class="mt-4">
                        <span class="p-float-label p-input-icon-right" :class="{ 'invalid-field-custom': v$.rfc.$error }">
                            <i class="pi pi-id-card" />
                            <InputText id="field-rfc" type="text" v-model="v$.rfc.$model"  @input="() => v$.rfc.$model = v$.rfc.$model.toUpperCase()"/>
                    ...
                    <b-col class="mt-3" cols="12" md="6" lg="4" sm="12">
                        <div class="field">
                            <span class="p-float-label p-input-icon-right">
                                ...
                                <label for="field-professional-id" class="form-label-required">Cédula profesional</label>
                            </span>
                        </div>
                    </b-col>
                </b-row>
